'''
This code is test code taken from https://github.com/treverhines/RBF to ensure RBF is properly installed
'''
...
plt.scatter(x_obs[:, 0], x_obs[:, 1], s=20, c=u_obs, vmin=-1.1, vmax=1.1,
